...
public class CredentialsAspect {
    ...
    @Before(value = "execution(* com.example.StudentManagementSystem.controller.CredentialsController.*(..))")
    ...
    @After(value = "execution(* com.example.StudentManagementSystem.controller.CredentialsController.*(..))")
