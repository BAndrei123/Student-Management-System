...
public class GroupsAspect {
    ...
    @Before(value = "execution(* com.example.StudentManagementSystem.controller.GroupsController.*(..))")
    ...
    @After(value = "execution(* com.example.StudentManagementSystem.controller.GroupsController.*(..))")
